module.exports = function showUsage(knownOpts, shortHands /*, description1, description2, ... */) {
    var descriptions = Array.prototype.slice.call(arguments, 2, arguments.length), knownOptsMaxLen = maxLength(Object.keys(knownOpts)), shortHands2 = {}, SPACE = 4;
    // create a shortHands object with the long name as key.
    Object.keys(shortHands).forEach(function (key) {
        if (key == "___singles")
            return; //Fixed by AlonW 18/12/2016
...
//# sourceMappingURL=nopt-usage-2.js.map